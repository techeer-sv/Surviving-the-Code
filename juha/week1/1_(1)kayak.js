// // 문제
// //2890번을 보면 알겠지만, 상근이는 카약 대회를 개최했다. 그런데, 갑자기 엄청난 강풍이 경기장에 불었고, 일부 카약이 부서졌다.
// //경기는 5분 안에 시작해야 하는 상황이다.
// //다행히 일부 팀은 혹시 모를 사태에 대비해서 카약을 하나 더 경기장에 들고 왔다. 카약은 매우 무겁고 운반하기 어렵다.
// //따라서, 자신의 바로 다음이나 전에 경기하는 팀에게만 카약을 빌려주려고 한다. 즉, 팀 4는 여분의 카약을 3이나 5에게만 빌려줄 수 있다.
...
// const damagedTeam = input[1].split(" ").map(Number);
// const extrakayakTeam = input[2].split(" ").map(Number);

// // 출력
// function solution(N, damagedTeam, extrakayakTeam) {}
